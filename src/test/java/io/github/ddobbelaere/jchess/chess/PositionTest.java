...
class PositionTest {
        ...
        void testMirror() {
                ...
                for (String legalFenString : getLegalFenStrings()) {
                        ...
                        assertEquals(true, position.isLegal(),
                                        "Mirrored position \"" + legalFenString + "\" is illegal.");
                }
        ...
        void testApplyMove() {
                ...
                List<Pair<Position, Move>> moveSequence = Arrays.asList(Pair.of(Position.STARTING, new Move("e2e4")),
                                ...
                                Pair.of(Position.fromFen("rnbqkbnr/pp2pppp/3P4/2p5/8/8/PPPP1PPP/RNBQKBNR b KQkq - 0 3"),
                                                new Move("c8f5")),
                                Pair.of(Position.fromFen(
                                                "rn1qkbnr/pp2pppp/3P4/2p2b2/8/8/PPPP1PPP/RNBQKBNR w KQkq - 1 4"),
                                                new Move("d6e7")),
                                ...
                                Pair.of(Position.fromFen("3rkbnr/pp3ppp/2n5/2p2b2/8/5N2/PPPP1PPP/RNBQKB1R b KQk - 1 6"),
                                                new Move("h7h5")),
                                Pair.of(Position.fromFen(
                                                "3rkbnr/pp3pp1/2n5/2p2b1p/8/5N2/PPPP1PPP/RNBQKB1R w KQk - 0 7"),
                                                new Move("f1d3")),
                                Pair.of(Position.fromFen(
                                                "3rkbnr/pp3pp1/2n5/2p2b1p/8/3B1N2/PPPP1PPP/RNBQK2R b KQk - 1 7"),
                                                new Move("h8h6")),
                                Pair.of(Position.fromFen(
                                                "3rkbn1/pp3pp1/2n4r/2p2b1p/8/3B1N2/PPPP1PPP/RNBQK2R w KQ - 2 8"),
                                                new Move("e1g1")),
                                Pair.of(Position.fromFen(
                                                "3rkbn1/pp3pp1/2n4r/2p2b1p/8/3B1N2/PPPP1PPP/RNBQ1RK1 b - - 3 8"),
                                                new Move("e8e7")),
                                Pair.of(Position.fromFen(
                                                "3r1bn1/pp2kpp1/2n4r/2p2b1p/8/3B1N2/PPPP1PPP/RNBQ1RK1 w - - 4 9"),
                                                null));
                ...
                moveSequence = Arrays.asList(
                                Pair.of(Position.fromFen(
                                                "rnbqkbnr/pppppppp/1N4N1/8/8/8/PPPPPPPP/R1BQKB1R w KQkq - 0 1"),
                                                new Move("b6a8")),
                                ...
                                Pair.of(Position.fromFen("Nnbqkbnr/pppp1ppp/6N1/4p3/8/8/PPPPPPPP/R1BQKB1R w KQk - 0 2"),
                                                new Move("g6h8")),
                                Pair.of(Position.fromFen("NnbqkbnN/pppp1ppp/8/4p3/8/8/PPPPPPPP/R1BQKB1R b KQ - 0 2"),
                                                null));
                ...
                for (List<Pair<Position, Move>> moveSequenceUnderTest : moveSequences) {
                        ...
                        for (Pair<Position, Move> moveUnderTest : moveSequenceUnderTest) {
                                if (position != null) {
                                        ...
                                        assertEquals(moveUnderTest.getLeft(), position,

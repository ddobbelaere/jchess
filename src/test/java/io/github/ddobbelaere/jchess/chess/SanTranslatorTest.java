...
class SanTranslatorTest {
        ...
        void testFromSan() {
                ...
                for (Triple<String, Move, Position> testCase : getTestCases()) {
                        assertEquals(testCase.getMiddle(),
                                        SanTranslator.fromSan(testCase.getLeft(), testCase.getRight()));
                }
                ...
                assertThrows(IllegalMoveException.class,
                                () -> SanTranslator.fromSan("Ne3",
                                                Position.fromFen("4k3/8/8/8/2N3N1/8/2N5/4K3 w - -")));
        }
        ...
        void testToSan() {
                for (Triple<String, Move, Position> testCase : getTestCases()) {
                        assertEquals(testCase.getLeft(),
                                        SanTranslator.toSan(testCase.getMiddle(), testCase.getRight()));
                }
        }
        ...
        private static List<Triple<String, Move, Position>> getTestCases() {
                return Arrays.asList(Triple.of("d4", new Move("d2d4"), Position.STARTING),
                                ...
                                Triple.of("Nbd7", new Move("b8d7"),
                                                Position.fromFen(
                                                                "rnbqk2r/pp2bppp/2p2n2/3p2B1/3P4/2NBP3/PP3PPP/R2QK1NR b KQkq - 1 7")),
                                Triple.of("O-O", Move.SHORT_CASTLING_BLACK,
                                                Position.fromFen(
                                                                "r1bqk2r/pp1nbppp/2p2n2/3p2B1/3P4/2NBP3/PPQ2PPP/R3K1NR b KQkq - 3 8")),
                                Triple.of("O-O-O", Move.LONG_CASTLING_WHITE,
                                                Position.fromFen(
                                                                "r1bqr1k1/pp1nbppp/2p2n2/3p2B1/3P4/2NBP3/PPQ1NPPP/R3K2R w KQ - 6 10")),
                                Triple.of("Bxf5", new Move("d7f5"),
                                                Position.fromFen(
                                                                "r3rnk1/3bbppp/2p2n2/qp1p1NB1/p2P2P1/3BP2P/PPQ1NP2/1K1R3R b - - 5 16")),
                                Triple.of("gxf5", new Move("g4f5"),
                                                Position.fromFen(
                                                                "r3rnk1/4bppp/2p2n2/qp1p1bB1/p2P2P1/3BP2P/PPQ1NP2/1K1R3R w - - 0 17")),
                                ...
                                Triple.of("Nc4e3", new Move("c4e3"),
                                                Position.fromFen("4k3/8/8/8/2N3N1/8/2N5/4K3 w - -")),
                                Triple.of("Nge3", new Move("g4e3"),
                                                Position.fromFen("4k3/8/8/8/2N3N1/8/2N5/4K3 w - -")),
                                Triple.of("N2e3", new Move("c2e3"),
                                                Position.fromFen("4k3/8/8/8/2N3N1/8/2N5/4K3 w - -")),
                                Triple.of("Bxf7#", new Move("c4f7"),
                                                Position.fromFen(
                                                                "r1bqkbnr/pppppppp/n7/7Q/2B1P3/8/PPPP1PPP/RNB1K1NR w KQkq - 5 4")),
                                ...
                                Triple.of("Rg1", new Move("h1g1"),
                                                Position.fromFen(
                                                                "r1bqkbnr/pppp1ppp/n3p3/7Q/2B1P3/5N2/PPPP1PPP/RNB1K2R w KQkq - 0 5")),
                                Triple.of("exd3e.p.", new Move("e4d3"),
                                                Position.fromFen(
                                                                "rnbqkbnr/pppp1ppp/8/8/3Pp3/2N2N2/PPP1PPPP/R1BQKB1R b KQkq d3 0 3")));
        }

...
class MoveGeneratorTest {
        ...
        void testGenerateKingSafety() {
                ...
                assertEquals(Board.getSquareBitboard("f1") | Board.getSquareBitboard("g1")
                                | Board.getSquareBitboard("h1")
                                | Board.getSquareBitboard("f2") | Board.getSquareBitboard("h2")
                                | Board.getSquareBitboard("g3")
                                | Board.getSquareBitboard("h3"), kingSafety.accessibleSquares);
                assertEquals(false, kingSafety.isCheck());
                assertEquals(false, kingSafety.isDoubleCheck());
                ...
                assertEquals(0L, kingSafety.attackLines);
                assertEquals(0L, kingSafety.pinnedPieces);
                assertEquals(Board.getSquareBitboard("d3") | Board.getSquareBitboard("d4")
                                | Board.getSquareBitboard("f3")
                ...
                assertEquals(Board.getSquareBitboard("g4") | Board.getSquareBitboard("g5")
                                | Board.getSquareBitboard("g6")
                                | Board.getSquareBitboard("h4") | Board.getSquareBitboard("h6"),
                                kingSafety.accessibleSquares);
                assertEquals(false, kingSafety.isCheck());
                assertEquals(false, kingSafety.isDoubleCheck());
        }
        ...
        void testGenerateKingMoves() {
                ...
                testCases.add(Pair.of(
                                Position.fromFen("r1bq1rk1/pp2ppbp/2np1np1/8/3NP3/2N1BP2/PPPQ2PP/R3KB1R w KQ - 3 9"),
                ...
                for (final Pair<Position, Move[]> testCase : testCases) {
                        ...
                        MoveGenerator.generateKingMoves(position, MoveGenerator.generateKingSafety(position),
                                        generatedMoves);
        ...
        void testGenerateKnightMoves() {
                ...
                for (final Pair<Position, Move[]> testCase : testCases) {
                        Position position = testCase.getLeft();
                        List<Move> generatedMoves = new ArrayList<>();
                        MoveGenerator.generateKnightMoves(position, MoveGenerator.generateKingSafety(position),
                                        generatedMoves);
        ...
        void testGenerateRookMoves() {
                ...
                for (final Pair<Position, Move[]> testCase : testCases) {
                        Position position = testCase.getLeft();
                        List<Move> generatedMoves = new ArrayList<>();
                        MoveGenerator.generateRookMoves(position, MoveGenerator.generateKingSafety(position),
                                        generatedMoves);
        ...
        void testGenerateBishopMoves() {
                ...
                testCases.add(Pair.of(Position.fromFen("rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq -"),
                                new Move[] { new Move("d1e2"), new Move("d1f3"), new Move("d1g4"), new Move("d1h5"),
                                                new Move("f1e2"),
                                                new Move("f1d3"), new Move("f1c4"), new Move("f1b5"),
                                                new Move("f1a6") }));
                ...
                for (final Pair<Position, Move[]> testCase : testCases) {
                        Position position = testCase.getLeft();
                        List<Move> generatedMoves = new ArrayList<>();
                        MoveGenerator.generateBishopMoves(position, MoveGenerator.generateKingSafety(position),
                                        generatedMoves);
        ...
        void testGeneratePawnMoves() {
                ...
                // Starting position.
                testCases.add(Pair.of(Position.STARTING,
                                new Move[] { new Move("a2a3"), new Move("a2a4"), new Move("b2b3"), new Move("b2b4"),
                                                new Move("c2c3"),
                                                new Move("c2c4"), new Move("d2d3"), new Move("d2d4"), new Move("e2e3"),
                                                new Move("e2e4"),
                                                new Move("f2f3"), new Move("f2f4"), new Move("g2g3"), new Move("g2g4"),
                                                new Move("h2h3"),
                                                new Move("h2h4") }));
                ...
                testCases.add(Pair.of(Position.fromFen("rnbqkbnr/ppp2ppp/8/3pp3/2PP4/8/PP2PPPP/RNBQKBNR w KQkq -"),
                                new Move[] { new Move("a2a3"), new Move("a2a4"), new Move("b2b3"), new Move("b2b4"),
                                                new Move("c4c5"),
                                                new Move("c4d5"), new Move("d4e5"), new Move("e2e3"), new Move("e2e4"),
                                                new Move("f2f3"),
                ...
                testCases.add(Pair.of(Position.fromFen("rnbqkbnr/p1p2ppp/8/1pPpp3/3P4/8/PP2PPPP/RNBQKBNR w KQkq b6"),
                                new Move[] { new Move("a2a3"), new Move("a2a4"), new Move("b2b3"), new Move("b2b4"),
                                                new Move("c5c6"),
                                                new Move("c5b6"), new Move("d4e5"), new Move("e2e3"), new Move("e2e4"),
                                                new Move("f2f3"),
                                                new Move("f2f4"), new Move("g2g3"), new Move("g2g4"), new Move("h2h3"),
                                                new Move("h2h4") }));
                ...
                testCases.add(Pair.of(Position.fromFen("rnbqkbnr/p1p3pp/8/1pPpPp2/8/8/PP2PPPP/RNBQKBNR w KQkq f6"),
                                new Move[] { new Move("a2a3"), new Move("a2a4"), new Move("b2b3"), new Move("b2b4"),
                                                new Move("c5c6"),
                                                new Move("e5e6"), new Move("e5f6"), new Move("e2e3"), new Move("e2e4"),
                                                new Move("f2f3"),
                                                new Move("f2f4"), new Move("g2g3"), new Move("g2g4"), new Move("h2h3"),
                                                new Move("h2h4") }));
                ...
                for (final Pair<Position, Move[]> testCase : testCases) {
                        Position position = testCase.getLeft();
                        List<Move> generatedMoves = new ArrayList<>();
                        MoveGenerator.generatePawnMoves(position, MoveGenerator.generateKingSafety(position),
                                        generatedMoves);
